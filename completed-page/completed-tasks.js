let completed_tasks = document.querySelector(".completed-tasks_tasks");
...
function createTask(e, value, date, done, className) {
  ...
  completed_tasks.firstElementChild.append(task);
}
